...
const state = () => ({gameId:'game',draft:{...baseDraft},workflowStep:'live',serverSetupStep:'serve-team',activeSet:1,servingTeam:'B',firstServerTeamA:'Änne',firstServerTeamB:'Ben',captainTeamA:'Alice',captainTeamB:'Bob',sideChangeInterval:7,leftTeam:'B',setScore:{A:8,B:6},serverIndex:{A:1,B:0},serveCounts:{A:4,B:3},correctionMode:true,sideChangeAck:14,timeoutScore:{A:'8:6',B:null},activeTimeoutTeam:'A',timeoutEndsAt:30000,timeoutRemaining:30,finalEditing:false,pointHistory:[]});

...
import { AdminApp, AuthCredentialApp } from "./admin/auth";
import { CourtLinksPanel, HvvCredentialsDialog, HvvProgressDialog, HvvTournamentDialog, sortHvvTournamentsByDate, TournamentPanel, AdminUsersPanel } from "./admin/dashboardSections";
import { GamesEditor, isAssignedCourt, isCompleted, resolvedReferee, sortGames } from "./admin/GamesEditor";
import { AppDialog, formatSyncTime, LinkOutput, scoreUrl } from "./admin/shared";
import "./styles.css";
...
function App() {
  ...
  return <AdminApp dashboard={(session) => <AdminDashboard session={session} />} />;
}

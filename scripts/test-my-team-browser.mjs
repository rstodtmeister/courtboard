...
try {
 ...
 const placeholders=[...['A','B','C','D'].flatMap(pool=>[1,2,3].map(place=>`Pool ${pool} Platz ${place}`)),'Pool A','Pool B','Pool C','Pool D','Gruppe E','Pool A 1.','Pool B 2.','Gewinner','Verlierer Spiel 3','Sieger 4'];
